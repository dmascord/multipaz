...
///   - onDocumentUnfocused: Callback invoked when a focused document is dismissed.
public struct DocumentList<EmptyContent: View, SelectedContent: View>: View {
    ...
    public var onDocumentUnfocused: (DocumentInfo) -> Void
    ...
    public init(
        ...
        onDocumentUnfocused: @escaping (DocumentInfo) -> Void = { _ in }
    ) {
        ...
        self.onDocumentUnfocused = onDocumentUnfocused
    }
                        ...
                        ScrollView {
                            ZStack(alignment: .topLeading) {
                                ...
                                if let focusedDoc = focusedDocument {
                                    ...
                                    .frame(width: maxWidth, height: detailHeight)
