 ...
 * @param onDocumentUnfocused Callback invoked when a focused document is dismissed.
 *
...
fun DocumentList(
    ...
    onDocumentUnfocused: (documentInfo: DocumentInfo) -> Unit = {}
) {
    if (unfocusedVisiblePercent < 0 || unfocusedVisiblePercent > 100) {
                    ...
                    Box(
                        modifier = Modifier
                            ...
                            .clickable {
                                ...
                                if (isAnyFocused) {
                                    focusedDocument?.let { onDocumentUnfocused(it) }
                                } else {
